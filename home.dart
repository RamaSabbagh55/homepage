            ...
            TextField(
              decoration: InputDecoration(
                ...
                hintStyle: TextStyle(
                  ...
                  fontSize: 15, // You can also adjust the font size if needed
                ),
            ...
            Container(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  bottomBox(Icons.account_balance_wallet, "Financial management"), // Second box
                  bottomBox(Icons.map, "Ready Trips"), // Third box
                  bottomBox(Icons.alarm, "Create your own trip"), // Fourth box
                ],
              ),
            ),
          ],
      ...
      children: [
        ...
        Text(
          ...
          style: TextStyle(
              fontSize: 14.0,
              color: Color(0xFF638889),
              fontWeight: FontWeight.bold), // Style for category label
...
Widget bottomBox(IconData icon, String label) {
  return Container(
    ...
    child: Column(
      ...
      children: [
        Icon(icon, size: 40, color: Color(0xFF638889)), // Icon at the top
        SizedBox(height: 10), // Space between icon and label
        Text(
          label,
          style: TextStyle(
